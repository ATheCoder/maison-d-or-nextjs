...
export default async function PassportPage() {
  // Redirects to /profiles outside child mode; getFlagSeals re-resolves the
  ...
  return (
    <ThemeProvider childId={child.id}>
      <FlagCollectionView seals={seals} earnedCount={earnedCount} totalCountries={totalCountries} />
    </ThemeProvider>
  );
}
